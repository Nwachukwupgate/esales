      ...
      <div className="md:px-12 lg:px-28">
        <div className="container m-auto space-y-6 text-gray-300 ">
          ...
          <div className="m-auto flex w-max items-center justify-between space-x-4">
            ...
            <a href="google" title="facebook" target="_blank" rel="noopener noreferrer" aria-label="facebook">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="m-auto w-5"
            ...
            <a href="google" title="linkedin" target="_blank" rel="noopener noreferrer" aria-label="linkedin">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="m-auto w-5"
