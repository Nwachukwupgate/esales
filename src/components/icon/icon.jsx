...
export const FeatureItem = ({ iconColor, iconSvg, title, description }) => {
    return (
      <div className="mt-8 flex gap-4 md:items-center">
        <div className={`w-12 h-12 flex gap-4 rounded-full bg-${iconColor}-100 dark:bg-${iconColor}-900/20`}>
          {iconSvg}
        </div>
        <div className="w-5/6">
          <h4 className="font-semibold text-lg text-gray-700 dark:text-white">{title}</h4>
